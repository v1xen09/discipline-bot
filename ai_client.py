...
{{
  ...
  "monday":    [{{"time": "09:00", "task": "Название", "description": "детали", "type": "task"}}],
  "tuesday":   [...],
  "wednesday": [...],
  "thursday":  [...],
  "friday":    [...],
...
- Пометь каждый пункт полем "type": "task" или "reminder". "reminder" — фоновые пункты (завтрак, обед, прогулка, перерыв, пассивный отдых). "task" — всё что требует осознанного усилия.
