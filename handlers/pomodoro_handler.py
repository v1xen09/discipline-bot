...
/pomodoro [минуты]  — запустить рабочую сессию (по умолчанию 25 мин)
/pomodoro stop      — остановить активный таймер

После окончания сессии бот предлагает перерыв (5 или 15 мин) или новый помодоро.
Таймер хранится в user_data — один активный таймер на пользователя.
"""
